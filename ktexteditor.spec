...
Version  : 6.2.0
Release  : 81
URL      : https://download.kde.org/stable/frameworks/6.2/ktexteditor-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.2/ktexteditor-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/ktexteditor-6.2.0.tar.xz.sig
...
%setup -q -n ktexteditor-6.2.0
cd %{_builddir}/ktexteditor-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715643851
mkdir -p clr-build
pushd clr-build
