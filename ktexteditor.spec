...
Source0  : https://download.kde.org/stable/frameworks/5.90/ktexteditor-5.90.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.90/ktexteditor-5.90.0.tar.xz.sig
...
%prep
%setup -q -n ktexteditor-5.90.0
cd %{_builddir}/ktexteditor-5.90.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642097587
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ktexteditor-5.90.0/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/ktexteditor/680ed9349d3d12bd39ddd36e8c4bc6b1b0cb1c0e
cp %{_builddir}/ktexteditor-5.90.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/ktexteditor/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/ktexteditor-5.90.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/ktexteditor/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/ktexteditor-5.90.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/ktexteditor/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/ktexteditor-5.90.0/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/ktexteditor/a0193e3fccf86c17dc71e3f6c0ac0b535e06bea3
cp %{_builddir}/ktexteditor-5.90.0/templates/ktexteditor-plugin/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/ktexteditor/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5TextEditor.so.5.90.0
