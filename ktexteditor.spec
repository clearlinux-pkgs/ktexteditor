...
Source0  : https://download.kde.org/stable/frameworks/5.57/ktexteditor-5.57.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.57/ktexteditor-5.57.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1555203780
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5TextEditor.so.5.57.0
