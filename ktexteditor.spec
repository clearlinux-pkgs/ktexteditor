...
Source0  : https://download.kde.org/stable/frameworks/6.4/ktexteditor-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.4/ktexteditor-6.4.0.tar.xz.sig
Source2  : 2C8DF587A6D4AAC1.pkey
Summary  : Advanced embeddable text editor
Group    : Development/Tools
License  : BSD-2-Clause CC0-1.0 LGPL-2.0 MIT
Requires: ktexteditor-bin = %{version}-%{release}
...
%description
Tests if it is possible to move a line to the last line of the document (if the last line is empty).

%package bin
Summary: bin components for the ktexteditor package.
Group: Binaries
Requires: ktexteditor-data = %{version}-%{release}
Requires: ktexteditor-license = %{version}-%{release}

%description bin
bin components for the ktexteditor package.
...
%setup -q -n ktexteditor-6.4.0
cd %{_builddir}/ktexteditor-6.4.0
pushd ..
cp -a ktexteditor-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721057760
mkdir -p clr-build
pushd clr-build
...
%files bin
%defattr(-,root,root,-)
/V3/usr/bin/ktexteditor-script-tester6
/usr/bin/ktexteditor-script-tester6
