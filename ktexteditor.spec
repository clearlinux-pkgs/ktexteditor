...
Version  : 6.3.0
Release  : 82
URL      : https://download.kde.org/stable/frameworks/6.3/ktexteditor-6.3.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.3/ktexteditor-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.3/ktexteditor-6.3.0.tar.xz.sig
...
%setup -q -n ktexteditor-6.3.0
cd %{_builddir}/ktexteditor-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717795542
mkdir -p clr-build
pushd clr-build
