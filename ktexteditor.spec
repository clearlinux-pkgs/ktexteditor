...
Version  : 5.70.1
Release  : 31
URL      : https://download.kde.org/stable/frameworks/5.70/ktexteditor-5.70.1.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.70/ktexteditor-5.70.1.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.70/ktexteditor-5.70.1.tar.xz.sig
...
%prep
%setup -q -n ktexteditor-5.70.1
cd %{_builddir}/ktexteditor-5.70.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589837553
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ktexteditor-5.70.1/COPYING.GPL-2 %{buildroot}/usr/share/package-licenses/ktexteditor/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/ktexteditor-5.70.1/COPYING.LGPL-2 %{buildroot}/usr/share/package-licenses/ktexteditor/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/ktexteditor-5.70.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/ktexteditor/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
