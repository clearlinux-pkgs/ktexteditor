...
Version  : 5.104.0
Release  : 61
URL      : https://download.kde.org/stable/frameworks/5.104/ktexteditor-5.104.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.104/ktexteditor-5.104.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.104/ktexteditor-5.104.0.tar.xz.sig
...
%prep
%setup -q -n ktexteditor-5.104.0
cd %{_builddir}/ktexteditor-5.104.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679603089
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5TextEditor.so.5.104.0
