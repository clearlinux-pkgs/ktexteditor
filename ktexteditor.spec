...
Version  : 6.9.0
Release  : 90
URL      : https://download.kde.org/stable/frameworks/6.9/ktexteditor-6.9.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.9/ktexteditor-6.9.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.9/ktexteditor-6.9.0.tar.xz.sig
...
%setup -q -n ktexteditor-6.9.0
cd %{_builddir}/ktexteditor-6.9.0
pushd ..
cp -a ktexteditor-6.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735261613
mkdir -p clr-build
pushd clr-build
